<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Eclipsa.Master" AutoEventWireup="true" CodeBehind="AddWorkout.aspx.cs" Inherits="Eclipsa.AddWorkout" %>
...
<section class="first">
 ...
 <span class="help-block">
     <asp:RequiredFieldValidator ID="RequiredWorkoutValidator1" runat="server" ErrorMessage="Name is Required"
 ...
 <div class="has-error">
 <span class="help-block">
      <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Model is Required"
                                    ControlToValidate="Step1Box" Display="Dynamic" ValidationGroup="AllValidators"></asp:RequiredFieldValidator>
