<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Eclipsa.Master" AutoEventWireup="true" CodeBehind="EditTrainee.aspx.cs" Inherits="Eclipsa.EditTrainee" %>
<%--Edit Trainee Page--%>
        ...
        <div class="container">
            ...
            <div class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-4">
                        <asp:TextBox ID="Age" runat="server" CssClass="form-control" TextMode="Number"></asp:TextBox>
                        <div class="has-error">
                            <span class="help-block">
                ...
                <div class="form-group">
                    <div class="col-xs-4 col-xs-offset-4">
                        <asp:Button ID="TraineeEditButton" runat="server" Text="Submit" CssClass="btn btn-success"
                            ValidationGroup="AllValidators" OnClick="TraineeEditButton_Click" />
