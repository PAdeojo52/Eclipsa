<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Eclipsa.Master" AutoEventWireup="true" CodeBehind="AddTrainee.aspx.cs" Inherits="Eclipsa.AddTrainee" %>
<%--Add Trainee Form--%>
        ...
        <div class="container">
            ...
            <div class="form-horizontal">
                ...
                <div class="form-group">
                    <asp:Label ID="Label1" runat="server" Text="900 Number"
                        AssociatedControlID="NineNumber" CssClass="col-xs-4 control-label"></asp:Label>
                    <div class="col-xs-4">
                        <asp:TextBox ID="NineNumber" runat="server" CssClass="form-control" TextMode="SingleLine" MaxLength="30"></asp:TextBox>
                        <div class="has-error">
                            <span class="help-block">
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="900 Number is required"
                        ...
                        <div class="has-error">
                            <span class="help-block">
                                ...
                                <asp:RangeValidator ID="HeightValidator" runat="server" ControlToValidate="Height" Display="Dynamic"
                                    ...
                                    ErrorMessage="Please enter a number representing Height of User (inches)" Type="Integer"></asp:RangeValidator>
                            </span>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="has-error">
                            <span class="help-block">
                                ...
                                <asp:RangeValidator ID="WeightValidator" runat="server" ControlToValidate="Weight" Display="Dynamic"
                                    ...
                                    ErrorMessage="Please enter a number representing Weight of User (lbs)" Type="Integer"></asp:RangeValidator>
                            </span>
                        </div>
                    </div>
                </div>
