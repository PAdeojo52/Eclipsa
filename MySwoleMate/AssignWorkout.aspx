<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Eclipsa.Master" AutoEventWireup="true" CodeBehind="AssignWorkout.aspx.cs" Inherits="Eclipsa.AssignWorkout" %>
...
<div class="form-group">
     ...
     <div class="form-group">
                    <div class="col-xs-4 col-xs-offset-4">
                        <asp:Button ID="AssignWorkout_Click" runat="server" Text="Assign" CssClass="btn btn-success"
                            OnClick="AssignAddButton_Click" ValidationGroup="AllValidators" />
